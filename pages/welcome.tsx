	...
	return (
		<div className="flex bg-infobg-light dark:bg-infobg-dark h-screen bg-no-repeat bg-cover bg-center">
			<p className="text-md -mt-1 text-white absolute top-4 left-4 xs:hidden md:text-6xl font-extrabold">
				👋 Welcome <br /> to <span className="text-pink-100 "> Kusai Kitchen </span>
			</p>
			<Slider activeSlide={selectedSlide}>
				<div>
					...
					<p className="text-md -mt-1 text-gray-500 dark:text-gray-200">
						To configure your Kusai Kitchen instance, we'll need some information
					</p>
					...
					<div className="flex">
						<button 
							type="button"
							onClick={() => window.open("https://docs.kusaikitchen.cloud/", "_blank", "noopener,noreferrer")}
				...
				<div>
					<p className="font-bold text-2xl dark:text-white" id="2">
						Make your Kusai Kitchen account
					</p>
					<p className="text-md -mt-1 text-gray-500 dark:text-gray-200">
						You need to create a Kusai Kitchen account to continue
					</p>
