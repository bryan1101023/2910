...
export async function handler(
	...
	if (type !== 'termination' && type !== 'suspension' && type !== 'warning' && type !== 'promotion' && type !== 'demotion' && type !== 'note' && type !== 'appeal_accepted' && type !== 'appeal_declined') return res.status(400).json({ success: false, error: 'Invalid type' });
